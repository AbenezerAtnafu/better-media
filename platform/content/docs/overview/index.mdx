...
<Cards>
  ...
  <Card
    ...
    description="Offload image resizing, virus scanning, and transcoding to a job queue so uploads stay fast."
  />
  <Card
    title="Secure Uploads"
    description="Magic-byte MIME validation, virus scanning, and duplicate detection built into the pipeline."
  />
  <Card
    title="Presigned URLs"
    description="Let clients upload directly to storage without proxying bytes through your server."
  />
</Cards>
...
<Steps>
  <Step>
    ### Installation
    Get Better Media running in your project in minutes.
    [View Installation](./overview/installation)
  </Step>
  <Step>
    ### Basic Usage
    Learn how to ingest your first file and save it to storage.
    [View Basic Usage](./overview/basic-usage)
  </Step>
  <Step>
    ### Explore Adapters
    Connect to S3, Postgres, Redis, and more.
    [View Adapters](../docs/storage)
  </Step>
</Steps>
